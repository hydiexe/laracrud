            ...
            <div class="card-header">
                ...
                <div class="pull-right">
                    ...
                    <a href="{{ url('programs/restore') }}" class="btn btn-info btn-sm">
                        <i class="fa fa-undo"></i> Pulihkan Semua
                    </a>
            ...
            <div class="card-body table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ url('programs/delete/'.$item->id) }}" class="btn btn-danger btn-sm"
                                        onclick="return confirm('Yakin hapus data permanen?')">
                                        Hapus permanen
                                    </a>

                                    {{-- <form action="{{ url('programs/delete/'.$item->id) }}" method="post" class="d-inline"
                        ...
                        @else
                            <tr>
                                <td colspan="4" class="text-center">Sampah Kosong</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
